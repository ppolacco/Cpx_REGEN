...
from math import pi,sin,cos, sqrt, atan2, atan, acos, tan, exp
import numpy as np
...
def polyShadedPortArea(geo, theta):
    ...
    shaded_area = poly_port.intersection(poly_odis).area
    
    area_port_tot = polygonArea(xport, yport)
    
    area_port = area_port_tot - shaded_area
