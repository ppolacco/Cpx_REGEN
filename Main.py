...
Reed_valve = True
Bearing = False
N_rot = 3100 # Compressor speed - RPM (3100 - 1450)
omega = N_rot/60*2*pi

# Thermodynamic properties at inlet of the compressor
T_in = 30 + 273 # Inlet temperature - K (30 + 273 - 90 + 273)
Q_in =  0.39  # Inlet quality (0.39 - 0.466)
...
(m_dot_final, eta_is_final, eta_v_final, W_dot_final, CV, axial_force, tangential_force, radial_force, tilting_moment, orbiting_force) = solverF.full_resolution(geo, property_matrix, 
