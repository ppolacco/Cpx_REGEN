...
results = {'geo_inputs' : geo_inputs, 'inputs' : inputs, 'eta_is' : [], 'eta_v' : [], 'm_dot' : [], 'W_dot' : [], 'CV' : [], 'axial_force' : [], 'radial_force' : [], 'radial_force_x' : [], 'radial_force_y' : [],}
...
(m_dot_final, eta_is_final, eta_v_final, W_dot_final, CV, axial_force, radial_force, tilting_moment_x, tilting_moment_y, tilting_moment) = solverF.full_resolution(geo, property_matrix, 
...
results['axial_force'].append(axial_force)
results['radial_force'].append(radial_force)
results['radial_force_x'].append(radial_force)
results['radial_force_y'].append(radial_force)
